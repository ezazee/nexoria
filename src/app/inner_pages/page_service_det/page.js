...
import Header from "@/components/InnerPages/ServiceDetails/Header";
import Details from "@/components/InnerPages/ServiceDetails/Details";
import Footer from "@/components/InnerPages/Common/Footer";

export const metadata = {
  title: 'Swak - Service Details',
  icons: {
...
export default function PageServiceDetails() {
  return (
    <body className="page-service-det-style1">
      <LoadingScreen />
      {/* Page Components */}
