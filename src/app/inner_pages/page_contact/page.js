...
import ContactMap from "@/components/InnerPages/Contact/ContactMap";
import ContactForm from "@/components/InnerPages/Contact/ContactForm";
...
export default function PageContact() {
  return (
    <body className="page-contact-style1">
      <LoadingScreen />
      {/* Page Components */}
