...
import Grid from "@/components/InnerPages/Product/Grid";
import Footer from "@/components/InnerPages/Common/Footer";

export const metadata = {
  title: 'Swak - Product Grid',
  icons: {
...
export default function PageProductGrid() {
  return (
    <body className="page-product-grid-style1">
      <LoadingScreen />
      {/* Page Components */}
