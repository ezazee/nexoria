...
import Header from "@/components/InnerPages/Wishlist/Header";
import Wishlist from "@/components/InnerPages/Wishlist/Wishlist";
...
export default function PageWishlist() {
  return (
    <body className="page-wishlist-style1">
      <LoadingScreen />
      {/* Page Components */}
