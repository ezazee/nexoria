...
import Header from "@/components/InnerPages/Services/Header";
import Services from "@/components/InnerPages/Services/Services";
import Video from "@/components/InnerPages/Services/Video";
import Contact from "@/components/InnerPages/Services/Contact";
import Testimonials from "@/components/InnerPages/Services/Testimonials";
...
export default function PageServices() {
  return (
    <body className="page-services-style1">
      <LoadingScreen />
      {/* Page Components */}
