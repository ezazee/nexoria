...
import Blog from "@/components/InnerPages/Blog/Masonry";
...
export default function PageBlogMasonry() {
  return (
    <body className="page-blog-masonry-style1">
      <LoadingScreen />
      {/* Page Components */}
      <div id="scrollsmoother-container">
        <TopNavbar />
        <Header title="Blog Masonry" />
        <main>
          <Blog />
        </main>
        <Footer />
