...
import Grid from "@/components/InnerPages/Portfolio/Grid";
import Footer from "@/components/InnerPages/Common/Footer";

export const metadata = {
  title: 'Swak - Portfolio Grid',
  icons: {
...
export default function PagePortfolioGrid() {
  return (
    <body className="page-portfolio-grid-style1">
      <LoadingScreen />
      {/* Page Components */}
