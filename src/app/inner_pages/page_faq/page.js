...
import Header from "@/components/InnerPages/FAQ/Header";
import FAQ from "@/components/InnerPages/FAQ/FAQ";
import ContactInfo from "@/components/InnerPages/FAQ/ContactInfo";
import ContactMap from "@/components/InnerPages/FAQ/ContactMap";
...
export default function PageFAQ() {
  return (
    <body className="page-faq-style1">
      <LoadingScreen />
      {/* Page Components */}
