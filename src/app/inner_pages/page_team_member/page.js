...
import Header from "@/components/InnerPages/TeamMember/Header";
import Member from "@/components/InnerPages/TeamMember/Member";
import Footer from "@/components/InnerPages/Common/Footer";

export const metadata = {
  title: 'Swak - Team Member',
  icons: {
...
export default function PageTeamMember() {
  return (
    <body className="page-team-member-style1">
      <LoadingScreen />
      {/* Page Components */}
