      ...
      <div className="container">
        <div className="foot-content">
          <div className="info text-center">
            ...
            <p> <a href="#" className="fsz-16 color-999 text-uppercase hover-lightGreen1 lh-6 js-splittext-lines"> hello@Swakstudio.co </a> </p>
            <p> <a href="#" className="fsz-16 color-999 text-uppercase hover-lightGreen1 lh-6 js-splittext-lines"> 90 Fairground rd, florida 3290, us </a> </p>
            <p> <a href="#" className="fsz-16 color-999 text-uppercase hover-lightGreen1 lh-6 js-splittext-lines"> +32 (0)50 31 28 32 </a> </p>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="links my-3 my-lg-0">
                ...
                <Link href="/inner_pages/page_portfolio_showcase"> works </Link>
                <Link href="/inner_pages/page_about_us"> about </Link>
                <Link href="/inner_pages/page_blog_grid"> news </Link>
                <Link href="/inner_pages/page_contact"> contact </Link>
                <Link href="/inner_pages/page_team"> team </Link>
              </div>
            </div>
